...
//   });  
  ...
  const registrationOldExp = errorHandling.asyncHandler(async(req,res,next)=>{
...
const formatToDate = new Intl.DateTimeFormat("en-us", {
  ...
  year: "numeric",
    ...
    const newUser = new registrationSchemaForOldExp({ ...userData, password,birthDate:formatToDate.format(changDate)
    });
