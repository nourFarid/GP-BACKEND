const registrationSchemaForNewExp=require('../../../../DB/model/newComers/registrationExpatriates.js')
...
//   });  
  ...
  const registrationNewExp = errorHandling.asyncHandler(async(req,res,next)=>{
...
const formatToDate = new Intl.DateTimeFormat("en-us", {
  ...
  year: "numeric",
    ...
    const newUser = new registrationSchemaForNewExp({ ...userData, password,birthDate:formatToDate.format(changDate)
    });
...
module.exports={registrationNewExp}
