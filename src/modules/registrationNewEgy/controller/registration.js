const registrationSchemaForNewEgy=require('../../../../DB/model/newComers/registrationEgyption.js')
...
//   });  
  ...
  const registrationNewEgy = errorHandling.asyncHandler(async(req,res,next)=>{
...
const formatToDate = new Intl.DateTimeFormat("en-us", {
  ...
  year: "numeric",
    ...
    const newUser = new registrationSchemaForNewEgy({ ...userData, password,birthDate:formatToDate.format(changDate)
    });
...
module.exports={registrationNewEgy}
